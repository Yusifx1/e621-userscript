...
var time = JSON.parse(window.localStorage.getItem("e621subchecktime"));
...
var saved = JSON.parse(window.localStorage.getItem("e621downByYusifx1"));
if (window.localStorage.getItem("e621downByYusifx1")) {
    ...
    if (saved.check2 == undefined) {
        saved.check2 = false;
    }
    if (saved.check3 == undefined) {
        saved.check3 = false;
    }
